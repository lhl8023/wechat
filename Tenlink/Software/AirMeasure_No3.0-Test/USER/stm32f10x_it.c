...
extern unsigned int flag_display, count_display;
extern unsigned int flag_Temperature, count_Temperature;
...
//        }
        ...
        //前3分钟温度补偿-2.0，中间5分钟补偿-2.5，再13分钟补偿3.0，最后补偿3.8
        count_Temperature++;
        if(count_Temperature >= Time_40min)
        {
        		count_Temperature = Time_40min;
        		flag_Temperature = 10;
        }
        else if(count_Temperature >= Time_30min)
        {
        		flag_Temperature = 9;
        }
        else if(count_Temperature >= Time_20min)
        {
        		flag_Temperature = 8;
        }
        else if(count_Temperature >= Time_15min)
        {
        		flag_Temperature = 7;
        }
        else if(count_Temperature >= Time_10min)
        {
        		flag_Temperature = 6;
        }
        else if(count_Temperature >= Time_8_5min)
        {
        		flag_Temperature = 5;
        }
        else if(count_Temperature >= Time_7min)
        {
        		flag_Temperature = 4;
        }
        else if(count_Temperature >= Time_5min)
        {
        		flag_Temperature = 3;
        }
        else if(count_Temperature >= Time_4min)
        {
        		flag_Temperature = 2;
        }
        else if(count_Temperature >= Time_2min)
        {
        		flag_Temperature = 1;
        }
        else
