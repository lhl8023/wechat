...
void SHT10_Config(void)
{
	...
	//初始化SHT10引脚时钟
	RCC_APB2PeriphClockCmd(SHT10_AHB2_CLK | RCC_APB2Periph_AFIO,ENABLE);
	       
	GPIO_InitStructure.GPIO_Pin = SHT10_DATA_PIN | SHT10_SCK_PIN;
